...
- **V2 结构**：`Physiology/` 与 `Pathophysiology/` 已退役（存档 38 个概念节点 + 2 份原 README），活跃概念节点 126
- **活跃概念节点**：126 = 学科节点 125（16 Immunology · **24 Medical Microbiology** · 17 Clinical Epidemiology · **20 Human Parasitology** · **48 Pathology**）+ 跨学科目录 1（Diseases）
