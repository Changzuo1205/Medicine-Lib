...
- **V2 结构**：`Physiology/` 与 `Pathophysiology/` 已退役（存档 38 个概念节点 + 2 份原 README），活跃概念节点 178
- **活跃概念节点**：178 = 学科节点 177（**31 Immunology** · **40 Medical Microbiology** · 17 Clinical Epidemiology · **20 Human Parasitology** · **69 Pathology**）+ 跨学科目录 1（Diseases）
